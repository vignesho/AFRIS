...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/neshv/Desktop/Projects/AFRIS/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                folder_path = r'C:\Users\neshv\Desktop\Projects\AFRIS\Attendance\-------Check atttendance-------'
    ...
    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="white", bg="indigo", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=20, bg="lightgrey", fg="black", font=('times', 23, ' bold '))
...
def err_screen():
    ...
    Label(sc1,text='Enrollment & Name required!!!',fg='black',bg='white',font=('times', 14, ' bold ')).pack()
    Button(sc1,text='OK',command=del_sc1,fg="white"  ,bg="blue"  ,width=5  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=100,y= 50)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/neshv/Desktop/Projects/AFRIS/' + fileName
    ...
    def Attf():
        folder_path = r'C:\Users\neshv\Desktop\Projects\AFRIS\Attendance'
        if os.path.exists(folder_path):
            subprocess.Popen(r'explorer /select,"{}"'.format(folder_path))
        else:
            print("Folder does not exist!")
    ...
    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="white", bg="indigo", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)

    tx = tk.Entry(windo, width=20, bg="light grey", fg="black", font=('times', 23, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'vignesh' :
            if password == 'viggy':
                ...
                cs = 'C:/Users/neshv/Desktop/Projects/AFRIS/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
                ...
                Nt.configure(text=valid, bg="blue2", fg="white", width=38, font=('times', 19, 'bold'))
    ...
    un_entr = tk.Entry(win, width=20, bg="lightgrey", fg="red", font=('times', 23, ' bold '))
    un_entr.place(x=290, y=55)

    def c11():
        pw_entr.delete(first=0, last=22)

    pw_entr = tk.Entry(win, width=20,show="*", bg="lightgrey", fg="red", font=('times', 23, ' bold '))
    ...
    Login = tk.Button(win, text="LogIn", fg="black", bg="lime green", width=20,
                       height=2,
                       activebackground="cyan",command=log_in, font=('times', 15, ' bold '))
...
message = tk.Label(window, text="AFRIS - AI Face Recognition and Identification System", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="Orange", font=('times', 15, ' bold '))
...
#text fields
txt = tk.Entry(window, width=20, bg="lightgrey", fg="black", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

txt2 = tk.Entry(window, width=20, bg="lightgrey", fg="black", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="Orange", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

clearButton = tk.Button(window, text="Clear",command=clear,fg="white"  ,bg="black"  ,width=10  ,height=1 ,activebackground = "grey" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="white"  ,bg="black"  ,width=10 ,height=1, activebackground = "grey" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Registered students",command=admin_panel,fg="white"  ,bg="indigo"  ,width=19 ,height=1, activebackground = "blue" ,font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Capture Images",command=take_img,fg="white"  ,bg="blue2"  ,width=20  ,height=3, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="white",command=trainimg ,bg="blue2"  ,width=20  ,height=3, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance",fg="black",command=subjectchoose  ,bg="lawn green"  ,width=20  ,height=3, activebackground = "cyan" ,font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manual Fill", command=manually_fill  ,fg="black"  ,bg="lawn green"  ,width=20  ,height=3, activebackground = "cyan" ,font=('times', 15, ' bold '))
